...
<form action="{{ route('admin.products.update', $product->slug) }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-6">
            ...
            @if($product->image)
                <img src="{{ asset('storage/' . $product->image) }}" alt="Current Image" class="img-thumbnail mt-2" width="120">
            @endif
        </div>
    </div>
    <div class="mb-3">
    ...
    <div class="row mb-3">
        ...
        <div class="col-md-3">
            ...
            <input type="number" name="weight" id="weight" class="form-control" value="{{ old('weight', $product->weight) }}" step="0.01" min="0">
        </div>
        <div class="col-md-3">
...
<form action="{{ route('admin.products.destroy', $product->slug) }}" method="POST" class="mt-3" onsubmit="return confirm('Are you sure you want to delete this product?');">
    @csrf
    @method('DELETE')
